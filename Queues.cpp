 ...
 * menggunakan struktur data queues dengan pendekatan Cirucular Arrays 
 * 
 * @section Operations
 * Project ini memiliki beberapa opsi antara lain:
 * 1. Insert
 * 2. Delete
 * 3. Display
 * 
 ...
 * @date 2025-06-24
 * 
 * @copyright Taradwi@umy.ac.id (C) 2025
 *
 */
...
/**
 * @class Queues
 * @brief class ini untuk operasi lengkap ueues
 * 
 * 
 */
class Queues 
{
    private:
        int max = 5; ///< variable private max untuk menyimpan posisi maximum antrian
    ...
    void remove()
    {
        // Cek apakah antrian kosog
        if (FRONT == -1)
        {
            cout << "Queue underflow\n";
            return;
        }
        cout << "\nThe Elements deleted form the queue is: " << queue_array[FRONT] << "\n";
    ...
    /**
     * @brief method untuk menampilkan data dalama antrian
